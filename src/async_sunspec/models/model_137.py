...
class Model137ReadOnly(IntEnum):
    """
...
class Model137CurveGroup(SunSpecGroup):
    """
    Attributes:
        ...
        ReadOnly (Model137ReadOnly): Enumerated value indicates if curve is read-only or can be modified.
    """
...
class Model137(SunSpecModel, model_name="lvrtc", id=137):
    """
    LVRT must remain connected

    Attributes:
        ActCrv (int): Index of active curve. 0=no active curve.
        ModEna (Model137ModEna): LVRT control mode. Enable active curve.  Bitfield value.
    ...
    curve: Annotated[Model137CurveGroup, ("SunSpecGroup", {"name": "curve", "group_type": Model137CurveGroup})]
