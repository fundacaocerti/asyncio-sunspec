...
class Model111St(IntEnum):
    """
    Enumerated value.  Operating state

    Members:
        ggOFF (int): ggOFF
        ggSLEEPING (int): ggSLEEPING
        ggSTARTING (int): ggSTARTING
        ggMPPT (int): ggMPPT
        ggTHROTTLED (int): ggTHROTTLED
        ggSHUTTING_DOWN (int): ggSHUTTING_DOWN
        ggFAULT (int): ggFAULT
        ggSTANDBY (int): ggSTANDBY
    """
    ggOFF = 1
    ggSLEEPING = 2
    ggSTARTING = 3
...
class Model111(SunSpecModel, model_name="inverter_single_phase_float", id=111):
    """
    ...
    Attributes:
        ...
        St (Model111St): Enumerated value.  Operating state
        StVnd (int): Vendor specific operating state code
        Evt1 (Model111Evt1): Bitmask value. Event fields
