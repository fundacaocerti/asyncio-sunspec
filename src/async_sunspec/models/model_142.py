...
class Model142ReadOnly(IntEnum):
    """
...
class Model142CurveGroup(SunSpecGroup):
    """
    Attributes:
        ...
        ReadOnly (Model142ReadOnly): Enumerated value indicates if curve is read-only or can be modified.
    """
...
class Model142(SunSpecModel, model_name="hfrtc", id=142):
    """
    HFRT must remain connected

    Attributes:
        ActCrv (int): Index of active curve. 0=no active curve.
        ModEna (Model142ModEna): LHzRT control mode. Enable active curve.  Bitfield value.
    ...
    curve: Annotated[Model142CurveGroup, ("SunSpecGroup", {"name": "curve", "group_type": Model142CurveGroup})]
