...
class Model129ReadOnly(IntEnum):
    """
...
class Model129(SunSpecModel, model_name="lvrt", id=129):
    """
    LVRT Must Disconnect

    Attributes:
        ActCrv (int): Index of active curve. 0=no active curve.
        ModEna (Model129ModEna): LVRT control mode. Enable active curve.  Bitfield value.
        WinTms (int): Time window for LVRT change.
        RvrtTms (int): Timeout period for LVRT curve selection.
    ...
    curve: Annotated[Model129CurveGroup, ("SunSpecGroup", {"name": "curve", "group_type": Model129CurveGroup})]
