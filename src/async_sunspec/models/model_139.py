...
class Model139ReadOnly(IntEnum):
    """
...
class Model139(SunSpecModel, model_name="lvrtx", id=139):
    """
    LVRT extended curve

    Attributes:
        ActCrv (int): Index of active curve. 0=no active curve.
        ModEna (Model139ModEna): LVRT control mode. Enable active curve.  Bitfield value.
    ...
    curve: Annotated[Model139CurveGroup, ("SunSpecGroup", {"name": "curve", "group_type": Model139CurveGroup})]
