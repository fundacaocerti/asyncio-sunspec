...
class Model144ReadOnly(IntEnum):
    """
...
class Model144CurveGroup(SunSpecGroup):
    """
    Attributes:
        ...
        ReadOnly (Model144ReadOnly): Enumerated value indicates if curve is read-only or can be modified.
    """
...
class Model144(SunSpecModel, model_name="hfrtx", id=144):
    """
    HFRT extended curve

    Attributes:
        ActCrv (int): Index of active curve. 0=no active curve.
        ModEna (Model144ModEna): LHzRT control mode. Enable active curve.  Bitfield value.
    ...
    curve: Annotated[Model144CurveGroup, ("SunSpecGroup", {"name": "curve", "group_type": Model144CurveGroup})]
