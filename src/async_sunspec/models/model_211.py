...
class Model211(SunSpecModel, model_name="ac_meter_an_or_ab_float", id=211):
    """
    Attributes:
        ...
        Evt (Model211Evt): Meter Event Flags
    """
    ...
    AphB: Annotated[float, ("SunSpecPoint", {'name': 'AphB', 'ptype': 'float32', 'mandatory': False, 'static': False})]
    AphC: Annotated[float, ("SunSpecPoint", {'name': 'AphC', 'ptype': 'float32', 'mandatory': False, 'static': False})]
    PhV: Annotated[float, ("SunSpecPoint", {'name': 'PhV', 'ptype': 'float32', 'mandatory': False, 'static': False})]
    PhVphA: Annotated[float, ("SunSpecPoint", {'name': 'PhVphA', 'ptype': 'float32', 'mandatory': False, 'static': False})]
    PhVphB: Annotated[float, ("SunSpecPoint", {'name': 'PhVphB', 'ptype': 'float32', 'mandatory': False, 'static': False})]
    PhVphC: Annotated[float, ("SunSpecPoint", {'name': 'PhVphC', 'ptype': 'float32', 'mandatory': False, 'static': False})]
    PPV: Annotated[float, ("SunSpecPoint", {'name': 'PPV', 'ptype': 'float32', 'mandatory': False, 'static': False})]
