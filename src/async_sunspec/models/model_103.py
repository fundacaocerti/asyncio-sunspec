...
class Model103(SunSpecModel, model_name="inverter_three_phase", id=103):
    """
    ...
    Attributes:
        ...
        Tmp_SF (int)
        St (Model103St): Enumerated value.  Operating state
        StVnd (int): Vendor specific operating state code
        Evt1 (Model103Evt1): Bitmask value. Event fields
    ...
    AphC: Annotated[int, ("SunSpecPoint", {'name': 'AphC', 'ptype': 'uint16', 'mandatory': True, 'static': False})]  # sf: A_SF
    ...
    PhVphC: Annotated[int, ("SunSpecPoint", {'name': 'PhVphC', 'ptype': 'uint16', 'mandatory': True, 'static': False})]  # sf: V_SF
