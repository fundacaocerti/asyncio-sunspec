...
class Model140ReadOnly(IntEnum):
    """
...
class Model140CurveGroup(SunSpecGroup):
    """
    Attributes:
        ...
        ReadOnly (Model140ReadOnly): Enumerated value indicates if curve is read-only or can be modified.
    """
...
class Model140(SunSpecModel, model_name="hvrtx", id=140):
    """
    HVRT extended curve

    Attributes:
        ActCrv (int): Index of active curve. 0=no active curve.
        ModEna (Model140ModEna): LVRT control mode. Enable active curve.  Bitfield value.
    ...
    curve: Annotated[Model140CurveGroup, ("SunSpecGroup", {"name": "curve", "group_type": Model140CurveGroup})]
