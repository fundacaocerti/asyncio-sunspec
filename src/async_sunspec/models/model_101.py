...
class Model101(SunSpecModel, model_name="inverter_single_phase", id=101):
    """
    ...
    Attributes:
        ...
        Tmp_SF (int)
        St (Model101St): Enumerated value.  Operating state
        StVnd (int): Vendor specific operating state code
        Evt1 (Model101Evt1): Bitmask value. Event fields
    ...
    AphB: Annotated[int, ("SunSpecPoint", {'name': 'AphB', 'ptype': 'uint16', 'mandatory': False, 'static': False})]  # sf: A_SF
    ...
    PhVphB: Annotated[int, ("SunSpecPoint", {'name': 'PhVphB', 'ptype': 'uint16', 'mandatory': False, 'static': False})]  # sf: V_SF
