...
class Model404StringGroup(SunSpecGroup):
    """
    Attributes:
        InID (int): Uniquely identifies this input set
        InEvt (Model404InEvt): String Input Event Flags
    ...
    InDCA: Annotated[int, ("SunSpecPoint", {'name': 'InDCA', 'ptype': 'int16', 'mandatory': True, 'static': False})]  # sf: InDCA_SF
    InDCAhr: Annotated[int, ("SunSpecPoint", {'name': 'InDCAhr', 'ptype': 'uint32', 'mandatory': False, 'static': False})]  # sf: InDCAhr_SF
    InDCV: Annotated[int, ("SunSpecPoint", {'name': 'InDCV', 'ptype': 'int16', 'mandatory': False, 'static': False})]  # sf: InDCV_SF
    InDCW: Annotated[int, ("SunSpecPoint", {'name': 'InDCW', 'ptype': 'int16', 'mandatory': False, 'static': False})]  # sf: InDCW_SF
    InDCWh: Annotated[int, ("SunSpecPoint", {'name': 'InDCWh', 'ptype': 'uint32', 'mandatory': False, 'static': False})]  # sf: InDCWh_SF
...
class Model404(SunSpecModel, model_name="string_combiner_advanced_inputs", id=404):
    """
    ...
    Attributes:
        ...
        Evt (Model404Evt): Bitmask value.  Events
        ...
        InDCA_SF (int): Current scale factor for inputs
        InDCAhr_SF (int): Amp-hour scale factor for inputs
        InDCV_SF (int): Voltage scale factor for inputs
        InDCW_SF (int): Power scale factor for inputs
        InDCWh_SF (int): Energy scale factor for inputs
    """
    ...
    DCV: Annotated[int, ("SunSpecPoint", {'name': 'DCV', 'ptype': 'int16', 'mandatory': False, 'static': False})]  # sf: DCV_SF
    ...
    DCPR: Annotated[int, ("SunSpecPoint", {'name': 'DCPR', 'ptype': 'int16', 'mandatory': False, 'static': False})]
    DCWh: Annotated[int, ("SunSpecPoint", {'name': 'DCWh', 'ptype': 'uint32', 'mandatory': False, 'static': False})]  # sf: DCWh_SF
    InDCA_SF: Annotated[int, ("SunSpecPoint", {'name': 'InDCA_SF', 'ptype': 'sunssf', 'mandatory': False, 'static': False})]
    InDCAhr_SF: Annotated[int, ("SunSpecPoint", {'name': 'InDCAhr_SF', 'ptype': 'sunssf', 'mandatory': False, 'static': False})]
    InDCV_SF: Annotated[int, ("SunSpecPoint", {'name': 'InDCV_SF', 'ptype': 'sunssf', 'mandatory': False, 'static': False})]
    InDCW_SF: Annotated[int, ("SunSpecPoint", {'name': 'InDCW_SF', 'ptype': 'sunssf', 'mandatory': False, 'static': False})]
    InDCWh_SF: Annotated[int, ("SunSpecPoint", {'name': 'InDCWh_SF', 'ptype': 'sunssf', 'mandatory': False, 'static': False})]
    string: Annotated[Model404StringGroup, ("SunSpecGroup", {"name": "string", "group_type": Model404StringGroup})]
