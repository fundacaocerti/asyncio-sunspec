...
class Model403StringGroup(SunSpecGroup):
    """
    Attributes:
        InID (int): Uniquely identifies this input set
        InEvt (Model403InEvt): String Input Event Flags
...
class Model403(SunSpecModel, model_name="string_combiner_current_input", id=403):
    """
    ...
    Attributes:
        ...
        Evt (Model403Evt): Bitmask value.  Events
    ...
    string: Annotated[Model403StringGroup, ("SunSpecGroup", {"name": "string", "group_type": Model403StringGroup})]
