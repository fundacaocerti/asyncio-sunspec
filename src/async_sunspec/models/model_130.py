...
class Model130ReadOnly(IntEnum):
    """
...
class Model130CurveGroup(SunSpecGroup):
    """
    Attributes:
        ...
        ReadOnly (Model130ReadOnly): Enumerated value indicates if curve is read-only or can be modified.
    """
...
class Model130(SunSpecModel, model_name="hvrt", id=130):
    """
    HVRT Must Disconnect

    Attributes:
        ActCrv (int): Index of active curve. 0=no active curve.
        ModEna (Model130ModEna): HVRT control mode. Enable active curve.  Bitfield value.
    ...
    curve: Annotated[Model130CurveGroup, ("SunSpecGroup", {"name": "curve", "group_type": Model130CurveGroup})]
