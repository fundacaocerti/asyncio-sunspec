...
class Model135ReadOnly(IntEnum):
    """
...
class Model135CurveGroup(SunSpecGroup):
    """
    Attributes:
        ...
        ReadOnly (Model135ReadOnly): Enumerated value indicates if curve is read-only or can be modified.
    """
...
class Model135(SunSpecModel, model_name="lfrt", id=135):
    """
    Low Frequency Ride-through

    Attributes:
        ActCrv (int): Index of active curve. 0=no active curve.
        ModEna (Model135ModEna): LHzRT control mode. Enable active curve.  Bitfield value.
    ...
    curve: Annotated[Model135CurveGroup, ("SunSpecGroup", {"name": "curve", "group_type": Model135CurveGroup})]
