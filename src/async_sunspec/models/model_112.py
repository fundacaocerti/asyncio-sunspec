...
class Model112(SunSpecModel, model_name="inverter_split_phase_float", id=112):
    """
    ...
    Attributes:
        ...
        St (Model112St): Enumerated value.  Operating state
        StVnd (int): Vendor specific operating state code
        Evt1 (Model112Evt1): Bitmask value. Event fields
