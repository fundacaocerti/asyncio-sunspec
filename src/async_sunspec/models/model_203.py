...
class Model203(SunSpecModel, model_name="ac_meter_abcn", id=203):
    """
    Attributes:
        ...
        Evt (Model203Evt): Meter Event Flags
    """
    ...
    PhVphC: Annotated[int, ("SunSpecPoint", {'name': 'PhVphC', 'ptype': 'int16', 'mandatory': True, 'static': False})]  # sf: V_SF
    ...
    PhVphBC: Annotated[int, ("SunSpecPoint", {'name': 'PhVphBC', 'ptype': 'int16', 'mandatory': True, 'static': False})]  # sf: V_SF
    PhVphCA: Annotated[int, ("SunSpecPoint", {'name': 'PhVphCA', 'ptype': 'int16', 'mandatory': True, 'static': False})]  # sf: V_SF
